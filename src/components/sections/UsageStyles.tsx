...
const styles = [
  {
    ...
    cta: { label: "まずは無料トライアル", signup: true as const },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title={
            <>
              目的に合わせて選べる
              <span className="text-gradient">3つの使い方</span>
            </>
          }
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {styles.map((s, i) => (
            ...
            >
              ...
              <h3
                className={`bg-gradient-to-r ${s.accent} bg-clip-text text-2xl font-bold text-transparent`}
              >
                {s.label}
              </h3>
              ...
              <p className="mt-5 grow text-sm leading-relaxed text-neutral-600">
                {s.description}
              </p>
