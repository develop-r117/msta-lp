...
const challenges = [
  {
    ...
    issue: "情報の更新が止まる",
    description:
      "リリース後、毎週のように発生する情報更新。コードを触らずに進められないと、すぐに更新が滞ります。",
    answer:
      "投稿コンテンツ・固定コンテンツ・お知らせを管理画面から即時更新。プログラミング不要でユーザーを退屈させません。",
    icon: "freeze",
  },
  {
    no: "02",
    issue: "ユーザーへの到達率が低い",
    description:
      "アプリを開いてもらえなければ、情報は届きません。多チャネルへの配信を後付けで作るのは大変です。",
    answer:
      "プッシュ通知 / メール配信 / ポップアップ / SNSリンクが標準搭載。セグメント配信で到達率も最適化できます。",
    icon: "reach",
  },
  {
    no: "03",
    issue: "改善の打ち手が分からない",
    description:
      "どの機能が使われているか・どこで離脱しているかが見えないと、改善のしようがありません。",
    answer:
      "標準分析 + Google Analytics 4 連携。新規登録・利用停止・スタンプ・DLまで多角的に可視化します。",
    icon: "analyze",
  },
  {
    no: "04",
    issue: "収益化の仕組みが整わない",
    description:
      "リリースしただけではマネタイズできません。EC・課金・広告を後から組み込むのは負担が重い。",
    answer:
      "EC / アプリ内課金・会員ランク / AdMob まで標準搭載。リリース後の収益化を最短ルートで設計できます。",
    icon: "money",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title={
            <>
              リリース後にこそ、
              <span className="text-gradient">本当の課題</span>が訪れる。
            </>
          }
