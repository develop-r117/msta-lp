      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {groups.map(({ title, items, icon: Icon, accent }, i) => (
            ...
            >
              <div className={`grid h-12 w-12 place-items-center rounded-2xl bg-gradient-to-br ${accent} text-primary-900 shadow-md`}>
                <Icon />
              </div>
        ...
        >
          <p className="text-xs font-bold uppercase tracking-widest text-accent-400">将来像</p>
