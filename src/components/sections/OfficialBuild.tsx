    ...
    <section id="official" className="section-padding relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title={<>自分で作るのが不安な方には、<span className="text-gradient">公式チームがサポート</span>。</>}
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <h3 className="mt-4 text-2xl font-bold text-neutral-900 md:text-3xl">公式チームが、丁寧にアプリ制作を代行</h3>
            <p className="mt-3 text-sm leading-relaxed text-neutral-600 md:text-base">
              企画相談から構築までサポート。ご予算に応じて、標準機能をアプリごとにカスタマイズすることも可能です。
            </p>
            <ul className="mt-6 space-y-2.5 text-sm text-neutral-700">
              <li className="flex items-start gap-2"><Dot /> オンラインMTGで詳細ヒアリング</li>
              <li className="flex items-start gap-2"><Dot /> カスタマイズ実装対応可能</li>
              <li className="flex items-start gap-2"><Dot /> 公開・運用までサポート</li>
            </ul>
          ...
          >
            ...
            <h3 className="mt-4 text-2xl font-bold leading-tight md:text-3xl">3hパック</h3>
            ...
            <ul className="mt-6 space-y-2.5 text-sm text-white/90">
              <li className="flex items-start gap-2"><Dot light /> 事前ヒアリングシートご提供</li>
              <li className="flex items-start gap-2"><Dot light /> 当日リアルタイム制作</li>
              <li className="flex items-start gap-2"><Dot light /> 当日中の完成を目指します</li>
            </ul>

            <div className="mt-6 rounded-2xl bg-white/10 p-4 ring-1 ring-white/20">
              <p className="text-xs font-semibold uppercase tracking-widest text-white/60">通常価格</p>
              <p className="mt-1 line-through opacity-70">¥70,000 / 回</p>
              <p className="mt-2 text-xs font-semibold uppercase tracking-widest text-white/60">ローンチ記念</p>
              <p className="mt-1 flex items-baseline gap-1">
                <span className="text-3xl font-black">¥35,000</span>
                <span className="text-sm font-semibold">/ 回</span>
                <span className="ml-2 inline-flex items-center rounded-full bg-accent-500 px-2 py-0.5 text-[10px] font-bold uppercase">半額</span>
              </p>
            </div>
            <div className="mt-6">
              <Button
...
function Dot({ light }: { light?: boolean }) {
  return (
    <span className={`mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full ${light ? "bg-white/70" : "bg-primary-500"}`} />
  );
}
