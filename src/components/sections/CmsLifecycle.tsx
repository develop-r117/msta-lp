...
const steps = [
  {
    no: "01",
    title: "情報発信",
    description: "プッシュ通知 / メール / ポップアップで、必要な情報を必要なユーザーに即時に届ける。",
  ...
  },
  {
    no: "02",
    title: "反応収集",
    description: "アンケート・問い合わせ・チャット・スタンプ利用で、ユーザーの声と行動データを集める。",
  ...
  },
  {
    no: "03",
    title: "分析",
    description: "標準分析 + Google Analytics で、利用率・継続率・収益への寄与を多角的に可視化する。",
  ...
  },
  {
    no: "04",
    title: "改善",
    description: "投稿・導線・機能ON/OFF・有償オプションまで、即日で打ち手を反映できる。",
    ...
    <section className="section-padding bg-neutral-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title={<>運用は、<span className="text-gradient">ループ</span>でまわす。</>}
          ...
          <ol className="grid gap-3 md:grid-cols-4">
            {steps.map((s, i) => (
              ...
              >
                ...
                <h3 className="mt-3 text-base font-bold text-neutral-900 md:text-lg">{s.title}</h3>
