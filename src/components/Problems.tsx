...
const problems = [
  {
    problem: "顧客との接点が少ない",
    solution: "プッシュ通知で新商品情報やキャンペーンを直接届け、チャット機能で1対1のコミュニケーションを実現",
    icon: "💬",
    stat: "300%",
    statLabel: "エンゲージメント向上",
  },
  {
    problem: "リピーターを増やしたい",
    solution: "スタンプカードやクーポン機能で、来店回数を増やし、リピーターを育成",
    icon: "🎯",
    stat: "45%",
    statLabel: "リピート率向上",
  },
  {
    problem: "予約業務が煩雑",
    solution: "オンライン予約システムで、24時間自動受付。予約状況を一元管理",
    icon: "📅",
    stat: "50%",
    statLabel: "業務効率化",
  },
  {
    problem: "アプリ開発の技術がない",
    solution: "プログラミング不要の管理画面。専門知識ゼロで運用可能",
    icon: "🚀",
    stat: "0円",
    statLabel: "初期開発費用",
  },
  {
    problem: "開発・運用コストが高い",
    solution: "初期費用無料、月額料金のみ。サーバー管理不要",
    icon: "💰",
    stat: "90%",
    statLabel: "コスト削減",
  },
